...
def main():
    ...
    keywords = ''
    notes = 'The \"crude death rate\" is the number of deaths divided by the population, multiplied by 100,000.'
    period = ''
    g_rate = 'TRUE'
    obs_vsd = 'TRUE'
    vsd = '2017-06-06'
    ...
    for series in pd.unique(df['fips'].ravel()):
        ...
        series_id = 'CDC20N2U' + series
        title = 'Premature Death Rate for ' + \
