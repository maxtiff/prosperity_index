...
crime_2012=crime_2012.filter(keep,axis=1)
...
crime_2011= pd.read_excel(data_dir + 'crime_11.xls',skiprows={0,1},header=2,skip_footer=8)
...
crime_2011=crime_2011.filter(keep,axis=1)
...
crime_2010= pd.read_excel(data_dir + 'crime_10.xls',skiprows={0,1},header=2,skip_footer=8)
crime_2010['State'].replace(to_replace='\s\-\s\w+\sCounties|\d$', value='',inplace=True,regex=True)
crime_2010= crime_2010.fillna(method='ffill')
crime_2010['date']='2010'
crime_2010=crime_2010.filter(keep,axis=1)
...
crime_2009= pd.read_excel(data_dir + 'crime_09.xls',skiprows={0,1},header=2,skip_footer=8)
...
crime_2009=crime_2009.filter(keep,axis=1)
...
crime_2008= pd.read_excel(data_dir + 'crime_08.xls',skiprows={0,1},header=2,skip_footer=8)
crime_2008['State'].replace(to_replace='\s\-\s\w+\sCounties|\d$', value='',inplace=True,regex=True)
crime_2008= crime_2008.fillna(method='ffill')
crime_2008['date']='2008'
crime_2008=crime_2008.filter(keep,axis=1)
...
crime_2007= pd.read_excel(data_dir + 'crime_07.xls',skiprows={0,1},header=2,skip_footer=8)
crime_2007['State'].replace(to_replace='\s\-\s\w+\sCounties|\d$', value='',inplace=True,regex=True)
crime_2007= crime_2007.fillna(method='ffill')
crime_2007['date']='2007'
crime_2007=crime_2007.filter(keep,axis=1)
...
crime_2006['State'].replace(to_replace='\s\-\s\w+\sCounties|\d$', value='',inplace=True,regex=True)
crime_2006= crime_2006.fillna(method='ffill')
crime_2006['date']='2006'
crime_2006=crime_2006.filter(keep,axis=1)
...
crime_2005['State'].replace(to_replace='\s\-\s\w+\sCounties|\d$', value='',inplace=True,regex=True)
crime_2005= crime_2005.fillna(method='ffill')
crime_2005['date']='2005'
crime_2005=crime_2005.filter(keep,axis=1)
